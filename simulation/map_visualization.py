...
Note:
    This is mainly for ASC. For FSGP elevation data isn't AS important since
    it's a grand prix. However, would be cool to have lap by lap coloured map
    gradients for best speeds for FSGP.
"""
